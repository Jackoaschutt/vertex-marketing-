      ...
      <div className="w-full max-w-lg mx-4 bg-slate-900 border border-amber-600/70 rounded-2xl p-8 shadow-2xl flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 rounded-xl font-semibold text-sm border border-slate-700 text-slate-400 hover:border-zinc-500 hover:text-slate-200 transition-colors disabled:opacity-40"
          >
            End Session Now
          </button>
        </div>
  ...
  return (
    <div>
      ...
      <textarea
        ...
        className={`w-full bg-slate-800 border rounded-lg px-3 py-2.5 text-sm text-white focus:outline-none focus:ring-2 focus:ring-amber-500 placeholder:text-zinc-600 resize-none transition-colors ${
