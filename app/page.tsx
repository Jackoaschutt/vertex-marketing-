...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      'Track every rule violation and circuit breaker trigger automatically — build the discipline data your prop firm evaluation demands.',
    icon: (
    ...
    <div className="min-h-screen bg-[#0b0f1a]">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-20 pb-16 text-center">
        ...
        <p className="mt-5 text-lg text-slate-400 max-w-2xl mx-auto">
          ...
          breakers, session accountability, and analytics built for prop firm traders.
        </p>
        <div className="mt-8 flex items-center justify-center gap-4">
          <Link
            href="/signup"
            className="bg-teal-500 hover:bg-teal-400 text-white font-semibold rounded-lg px-6 py-3 transition"
          >
      ...
      <section className="max-w-6xl mx-auto px-6 pb-20">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {FEATURES.map((feature) => (
            <div
              key={feature.title}
              className="bg-[#111827] border border-slate-800/50 rounded-2xl p-6"
            >
      ...
      <section className="max-w-6xl mx-auto px-6 pb-24">
        ...
        <div className="bg-[#111827] border border-slate-800/50 rounded-2xl p-8 max-w-md mx-auto flex flex-col gap-6">
          <div>
          ...
          <Link
            href="/signup"
            className="bg-teal-500 hover:bg-teal-400 transition-colors w-full py-3 text-center text-base font-semibold text-white rounded-lg"
          >
            Start Free Trial
          </Link>
        </div>
